...
try:
    from tensorgraph.models_zoo.aibraintumormodel.nn.model \
        import model_C3 as model_module
except:
    warnings.warn("WARNING: Unable to locate model_C3 in TensorGraph package. Attempting relative path import")
    model_path = "../../../tensorgraph/models_zoo/"
    sys.path.append(model_path)
    from aibraintumormodel.nn.model import model_C3 as model_module
