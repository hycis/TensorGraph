...
try:
    from tensorgraph.models_zoo.aibraintumormodel.nn.model \
        import model_CR as model_module
except:
    warnings.warn("WARNING: Unable to locate model_CR in TensorGraph package. Attempting relative path import")
    model_path = "../../../tensorgraph/models_zoo/"
    sys.path.append(model_path)
    from aibraintumormodel.nn.model import model_CR as model_module
